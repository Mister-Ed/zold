...
#######################################################################
# Default has for ISO countries (refined and updated -- and moved -- from XML shipping libs)
#
%iso_countries = (
'AF' => 'Afghanistan',
'AX' => '�land Islands',
...
# to convert country names to ISO codes
%iso_countries_to_codes = (
### extra thingies, just in case ###
'USA' => 'US',
'England' => 'GB',
'Taiwan' => 'TW',
'Venezuela' => 'VE',
